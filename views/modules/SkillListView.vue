...
<template>
  <div class="container py-4">
    ...
    >
      <template #body>
        <SkillForm :modelValue="formModel" :busy="ui.busy" @submit="onSave" @cancel="closeModal" />
      </template>
    </AddModal>
  </div>
</template>
...
import { useSkillStore } from '../../stores/modules/skill'
